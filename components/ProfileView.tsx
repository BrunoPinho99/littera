        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white dark:bg-surface-dark rounded-[2rem] p-8 border border-gray-100 dark:border-slate-800 shadow-sm">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">{isInstitution ? "Nome da Escola" : "Instituição Vinculada"}</label>
                ...
                {!isInstitution && <p className="text-[9px] text-gray-400 mt-1 italic">* O vínculo institucional é gerido pela conta mestre da escola.</p>}
              </div>
            </div>
          </div>
