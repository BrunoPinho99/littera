      ...
      `}</style>
            ...
            <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-100 dark:bg-violet-900/30 text-primary text-xs font-semibold mb-6 border border-violet-200 dark:border-violet-800">
                        <span className="flex h-2 w-2 rounded-full bg-primary"></span>
                        Versão 2.0 com IA Generativa
                    </div>
                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 text-gray-900 dark:text-white leading-tight max-w-5xl mx-auto">
                    ...
                    <p className="mt-4 text-xl text-muted-light dark:text-muted-dark max-w-2xl mx-auto mb-10">
